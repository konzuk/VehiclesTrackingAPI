...
using VehicleTrackingAPI;

namespace VehicleTrackingAPI.Migrations
{
    [DbContext(typeof(VTApiDbContext))]
    partial class VTApiDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VehicleTrackingAPI.Models.PositionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleTrackingAPI.Models.UserEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleTrackingAPI.Models.UserRoleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleTrackingAPI.Models.VehicleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("VehicleTrackingAPI.Models.UserRoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("VehicleTrackingAPI.Models.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VehicleTrackingAPI.Models.VehicleEntity", b =>
                {
                    b.HasOne("VehicleTrackingAPI.Models.UserEntity", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
